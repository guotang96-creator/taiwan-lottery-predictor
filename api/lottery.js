export default function handler(req, res) {
  ...
  const db = {
    bingo: [
      ...
      { issue: "B009", date: "2026-03-09", numbers: [1,2,10,11,20,21,25,26,35,36,40,41,45,46,55,56,60,61,75,76] },
      { issue: "B010", date: "2026-03-08", numbers: [3,4,8,9,17,18,22,23,31,32,38,39,43,44,51,52,58,59,66,67] },
      { issue: "B011", date: "2026-03-07", numbers: [6,7,13,14,19,20,24,25,28,29,34,35,42,43,50,51,62,63,72,73] },
      { issue: "B012", date: "2026-03-06", numbers: [5,10,12,16,21,26,27,30,33,37,41,45,49,53,57,60,64,68,71,74] }
    ],
    lotto: [
      ...
      { issue: "L009", date: "2026-02-17", numbers: [3, 11, 15, 28, 33, 46] },
      { issue: "L010", date: "2026-02-14", numbers: [2, 6, 17, 25, 39, 43] },
      { issue: "L011", date: "2026-02-10", numbers: [1, 12, 18, 29, 34, 41] },
      { issue: "L012", date: "2026-02-07", numbers: [4, 9, 16, 21, 35, 44] }
    ],
    power: [
      ...
      { issue: "P009", date: "2026-02-17", numbers: [1, 10, 14, 22, 29, 36], second: 8 },
      { issue: "P010", date: "2026-02-13", numbers: [3, 7, 16, 20, 27, 34], second: 2 },
      { issue: "P011", date: "2026-02-10", numbers: [2, 11, 18, 24, 31, 35], second: 5 },
      { issue: "P012", date: "2026-02-06", numbers: [6, 9, 13, 21, 30, 37], second: 1 }
    ],
    "539": [
      ...
      { issue: "539009", date: "2026-03-09", numbers: [8, 13, 20, 27, 35] },
      { issue: "539010", date: "2026-03-08", numbers: [5, 11, 19, 23, 31] },
      { issue: "539011", date: "2026-03-07", numbers: [7, 14, 17, 22, 36] },
      { issue: "539012", date: "2026-03-06", numbers: [6, 12, 18, 24, 33] }
    ]
  };

  const draws = (db[game] || []).slice(0, count);
